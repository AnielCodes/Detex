  ...
  const products = [
    ...
    },
    {
      ...
      features: [
        ...
        "Factory-programmed, pre-wired delayed egress controller / power supply",
        ...
        "System does not require magnetic lock, panic provides delayed exit",
      ],
    ...
    },
    {
      ...
      image: RyobiLogo,
      features: [
        "Full hydraulic checking controls the door through the full opening and closing cycles",
        "Adjustable backcheck upon opening and adjustable general and latch speeds through closing cycle",
        "Heavy duty forged arms are interchangeable",
        "Adjustable Delayed-Action speed through closing cycle",
        "Many heavy duty and extra heavy duty configurations available",
      ],
